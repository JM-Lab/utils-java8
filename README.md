...
==============================
## version
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/kr.jmlab/jmlab-utils-java8/badge.svg)](http://search.maven.org/#artifactdetails%7Ckr.jmlab%7Cjmlab-utils-java8%7C0.1.86%7Cjar)
...
Checkout the source code:
    ...
    cd utils-java8
    git checkout -b 0.1.86 origin/0.1.86
    mvn install
