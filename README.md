...
==============================
## version
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/kr.jmlab/jmlab-utils-java8/badge.svg)](http://search.maven.org/#artifactdetails%7Ckr.jmlab%7Cjmlab-utils-java8%7C0.1.87%7Cjar)
...
Gradle:
```groovy
compile 'kr.jmlab:jmlab-utils-java8:0.1.87'
```
Maven:
```xml
<dependency>
...
Checkout the source code:
    ...
    cd utils-java8
    git checkout -b 0.1.87 origin/0.1.87
    mvn install
